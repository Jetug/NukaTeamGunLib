...
public class EntityTypes {
    ...
    public static final DeferredHolder<EntityType<ExampleChassis>> EXAMPLE_CHASSIS =
            registerEntity("example_chassis", EntityType.Builder
                    .of(ExampleChassis::new, MobCategory.MISC)
                    .sized(1.0f, 2.3f));


    private static <T extends Entity> DeferredHolder<EntityType<T>> registerEntity(String entityName, EntityType.Builder<T> builder) {
