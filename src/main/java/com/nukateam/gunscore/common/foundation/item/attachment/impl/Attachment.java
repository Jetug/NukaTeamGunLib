...
public abstract class Attachment {
    ...
    public static void addInformationEvent(ItemTooltipEvent event) {
        ...
        if (stack.getItem() instanceof IAttachment<?>) {
            ...
            if (perks != null && perks.size() > 0) {
                event.getToolTip().add(new TranslatableComponent("perk.gunscore.title").withStyle(ChatFormatting.GRAY, ChatFormatting.BOLD));
            ...
            if (outputSound > inputSound) {
                addPerk(negativePerks, false, "perk.gunscore.fire_volume.negative");
            } else if (outputSound < inputSound) {
                addPerk(positivePerks, true, "perk.gunscore.fire_volume.positive");
            }

            /* Test for silenced */
            for (IGunModifier modifier : modifiers) {
                if (modifier.silencedFire()) {
                    addPerk(positivePerks, true, "perk.gunscore.silenced.positive");
                    break;
                }
            }
            ...
            if (outputRadius > inputRadius) {
                addPerk(negativePerks, false, "perk.gunscore.sound_radius.negative");
            } else if (outputRadius < inputRadius) {
                addPerk(positivePerks, true, "perk.gunscore.sound_radius.positive");
            }
            ...
            if (additionalDamage > 0.0F) {
                addPerk(positivePerks, true, "perk.gunscore.additional_damage.positive", ItemStack.ATTRIBUTE_MODIFIER_FORMAT.format(additionalDamage / 2.0));
            } else if (additionalDamage < 0.0F) {
                addPerk(negativePerks, false, "perk.gunscore.additional_damage.negative", ItemStack.ATTRIBUTE_MODIFIER_FORMAT.format(additionalDamage / 2.0));
            }
            ...
            if (outputDamage > inputDamage) {
                addPerk(positivePerks, true, "perk.gunscore.modified_damage.positive");
            } else if (outputDamage < inputDamage) {
                addPerk(negativePerks, false, "perk.gunscore.modified_damage.negative");
            }
            ...
            if (outputSpeed > inputSpeed) {
                addPerk(positivePerks, true, "perk.gunscore.projectile_speed.positive");
            } else if (outputSpeed < inputSpeed) {
                addPerk(negativePerks, false, "perk.gunscore.projectile_speed.negative");
            }
            ...
            if (outputSpread > inputSpread) {
                addPerk(negativePerks, false, "perk.gunscore.projectile_spread.negative");
            } else if (outputSpread < inputSpread) {
                addPerk(positivePerks, true, "perk.gunscore.projectile_spread.positive");
            }
            ...
            if (outputLife > inputLife) {
                addPerk(positivePerks, true, "perk.gunscore.projectile_life.positive");
            } else if (outputLife < inputLife) {
                addPerk(negativePerks, false, "perk.gunscore.projectile_life.negative");
            }
            ...
            if (outputRecoil > inputRecoil) {
                addPerk(negativePerks, false, "perk.gunscore.recoil.negative");
            } else if (outputRecoil < inputRecoil) {
                addPerk(positivePerks, true, "perk.gunscore.recoil.positive");
            }
            ...
            if (outputAdsSpeed > inputAdsSpeed) {
                addPerk(positivePerks, true, "perk.gunscore.ads_speed.positive");
            } else if (outputAdsSpeed < inputAdsSpeed) {
                addPerk(negativePerks, false, "perk.gunscore.ads_speed.negative");
            }
            ...
            if (outputRate > inputRate) {
                addPerk(negativePerks, false, "perk.gunscore.rate.negative");
            } else if (outputRate < inputRate) {
                addPerk(positivePerks, true, "perk.gunscore.rate.positive");
            }
    ...
    private static void addPerk(List<Component> components, boolean positive, String id, Object... params) {
        components.add(new TranslatableComponent(positive ? "perk.gunscore.entry.positive" : "perk.gunscore.entry.negative", new TranslatableComponent(id, params).withStyle(ChatFormatting.WHITE)).withStyle(positive ? ChatFormatting.DARK_AQUA : ChatFormatting.GOLD));
    }
}
