package com.nukateam.gunscore.common.foundation.blockentity;

import com.nukateam.gunscore.common.foundation.container.WorkbenchContainer;
import com.nukateam.gunscore.common.foundation.blockentity.inventory.IStorageBlock;
import com.nukateam.gunscore.common.foundation.init.ModTileEntities;
...
public class WorkbenchBlockEntity extends SyncedBlockEntity implements IStorageBlock {
    ...
    public Component getDisplayName() {
        return new TranslatableComponent("container.gunscore.workbench");
    }
