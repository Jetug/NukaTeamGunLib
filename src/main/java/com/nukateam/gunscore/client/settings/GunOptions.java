package com.nukateam.gunscore.client.settings;

import com.nukateam.gunscore.Config;
import com.nukateam.gunscore.client.data.handler.CrosshairHandler;
import com.nukateam.gunscore.client.render.crosshair.Crosshair;
...
public class GunOptions {
    ...
    public static final ProgressOption ADS_SENSITIVITY = new GunSliderPercentageOption("gunscore.options.adsSensitivity", 0.0, 1.0, 0.01F, gameSettings -> {
        ...
        return new TranslatableComponent("gunscore.options.adsSensitivity.format", FORMAT.format(adsSensitivity));
    });

    public static final CycleOption<ResourceLocation> CROSSHAIR = CycleOption.create("gunscore.options.crosshair", () -> {
    ...
    /*public static final Option CROSSHAIR = CycleOption.create("gunscore.options.crosshair", () -> {
