...
//        poseStack.mulPose(Axis.YP.rotationDegrees(entity.laserYaw - 90F));
//        poseStack.mulPose(Axis.ZP.rotationDegrees(entity.laserPitch));
//
...
//
//        poseStack.mulPose(Axis.XP.rotationDegrees(rot_x + 90f));
