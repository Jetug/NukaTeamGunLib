...
//	}
	...
	public static List<TGParticleSystem> createFX(Level world, String fx, double posX, double posY, double posZ, double xo, double yo, double zo) {
		if (FXList.containsKey(fx.toLowerCase())) {
			TGFXType fxtype = FXList.get(fx.toLowerCase());
			List<TGParticleSystem> list = fxtype.createParticleSystems(world, posX, posY, posZ, xo, yo, zo);
			return list;
		}else {
	...
	public static List<TGParticleSystem> createFXOnParticle(Level worldIn, TGParticle ent, String fx) {
