...
public class GunOptions {
    ...
    public static final ProgressOption ADS_SENSITIVITY = new GunSliderPercentageOption("ntgl.options.adsSensitivity", 0.0, 1.0, 0.01F, gameSettings -> {
    ...
    /*public static final Option CROSSHAIR = CycleOption.create("ntgl.options.crosshair", () -> {
