...
import com.nukateam.azurelib.WeaponItemDispatcher;
...
public class WeaponItem extends Item implements IWeapon, IColored, IMeta{
    ...
    public final WeaponItemDispatcher dispatcher;

    public WeaponItem(Properties properties, IGunModifier... modifiers) {
        super(properties);
        this.modifiers = modifiers;
        // Create a basic dispatcher that can be overridden by subclasses
        this.dispatcher = createDispatcher();
    }

    // Override this method in subclasses to provide custom animation commands
    protected WeaponItemDispatcher createDispatcher() {
        return new WeaponItemDispatcher();
    }
