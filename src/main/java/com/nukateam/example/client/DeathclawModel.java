...
public class DeathclawModel<Type extends Deathclaw> extends EntityModel<Type> {
    private static final ResourceLocation model = ResourceLocation.tryBuild(Ntgl.MOD_ID, "geo/entity/deathclaw.geo.json");
    private static final ResourceLocation animation = ResourceLocation.tryBuild(Ntgl.MOD_ID, "animations/entity/deathclaw.animation.json");
    ...
    public ResourceLocation getTextureResource(Type object) {
        return ResourceLocation.tryBuild(Ntgl.MOD_ID, "textures/entity/deathclaw.png");
    }
